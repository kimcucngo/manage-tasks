...
<body class="bg-gradient-primary">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Wellcome to RinPage!</h1>
                  </div>
                  <form class="user">
  ...
  <script src="{{asset('frontend/css/jquery.easing.min.js')}}"></script>

  <!-- Custom scripts for all pages-->
  <script src="{{asset('frontend/css/sb-admin-2.min.js')}}"></script>
